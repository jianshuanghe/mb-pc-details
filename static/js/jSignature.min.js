...
(function() {
	...
	function m(b, j) {
		...
		this.resizeTo = function(b) {
			...
			else if (0 === this.x) this._length = b, this.y = b * s(this.y);
	...
	function r(b, j, a) {
		...
		this.$controlbarUpper = $('<div style="position:relative;padding:0 !important;margin:0 !important;width: 80% !important; height: 0 !important;margin-top:-1em !important;margin-bottom:1em !important;"></div>').appendTo(g);
		this.isCanvasEmulator = !1;
		a = this.canvas = this.initializeCanvas(d);
		j = $(a);
		this.$controlbarLower = $('<div style="position:relative;padding:0 !important;margin:0 !important;width: 80% !important; height: 0 !important;margin-top:-1.5em !important;margin-bottom:1.5em !important;"></div>').appendTo(g);
		...
		v = function(b) {
			...
			this.publish = function(b, a, g, d) {
				if (this.topics[b]) {
					...
					e = 0;
					for (h = l.length; e < h; e++) c.splice(l[e], 1)
				}
			};
	...
	r.prototype.initializeCanvas = function(b) {
		var a = document.createElement("canvas"),
			c = $(a);
			c.css("z-index", 66666);
		b.width === b.height && "ratio" === b.height && (b.width = "80%");
...
(function() {
	...
	function y(a) {
		...
		d = 0;
		for (c = p.length; d < c; d++) l = p[d], f.push('<path fill="none" stroke="#000000" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" d="' + e(l, k, n) + '"/>');
		f.push("</svg>");
		return f.join("")
	}
	function v(a) {
	...
	if ("function" !== typeof x) var x = function(a) {
			var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".split(""),
				...
				n = "",
				n = [];
			do d = a.charCodeAt(k++), c = a.charCodeAt(k++), h = a.charCodeAt(k++), i = d << 16 | c << 8 | h, d = i >> 18 & 63, c = i >> 12 & 63, h = i >> 6 & 63, i &= 63, n[m++] = e[d] + e[c] + e[h] + e[i];
			while (k < a.length);
			n = n.join("");
			a = a.length % 3;
